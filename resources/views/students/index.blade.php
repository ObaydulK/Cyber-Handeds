                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-600 dark:text-neutral-400">
                                This company all inter student
                            </p>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <div class="flex items-center gap-x-3">
                                                <span
                                                    class="text-xs text-gray-500 dark:text-neutral-500">{{$student->bio}}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap">
                                        <div class="px-6 py-3">
                                            <span
                                                class="text-sm text-gray-500 dark:text-neutral-500">{{$student->created_at}}</span>
                                        </div>
                                    </td>
                                    <td class="size-px whitespace-nowrap  ">
                                        <div class="flex" >
