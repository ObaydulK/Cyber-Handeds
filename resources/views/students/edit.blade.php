    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-neutral-800">
        <div class="mb-8">
            ...
            <p class="text-sm text-gray-600 dark:text-neutral-400">
                Edit your Profile, password and account settings.
            </p>
        </div>
        <form action="{{ route('students.update', $student->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                        ...
                        <div class="flex gap-x-2">
                            <div>
                                <button type=""
                                    ...
                                    @if ($student->image)
                                        <img src="{{asset('storage/' . $student->image)}}" alt="image" width="50">
                                    @endif
                ...
                <div class="sm:col-span-9">
                    <div class="sm:flex">
                        <input id="af-account-full-name" type="text" name="name" required value="{{old('name', $student->name)}}"
                ...
                <div class="sm:col-span-9">
                    <input id="af-account-email" type="email" name="email" required value="{{old('email', $student->email)}}"
                ...
                <div class="sm:col-span-9">
                    <div class="sm:flex">
                        <input id="af-account-phone" type="text" name="phone" required value="{{old('phone', $student->phone)}}"
                            class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            placeholder="enter you numbers">
                    </div>
                </div>
                <!-- End Col -->
                ...
                <div class="sm:col-span-9">
                    <div class="sm:flex">
                        <input id="af-account-full-position" type="text" name="position" required value="{{old('position', $student->position)}}"
                            class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm -mt-px -ms-px first:rounded-t-lg last:rounded-b-lg sm:first:rounded-s-lg sm:mt-0 sm:first:ms-0 sm:first:rounded-se-none sm:last:rounded-es-none sm:last:rounded-e-lg text-sm relative focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                            placeholder="Maria">
                    </div>
                </div>
                ...
                <div class="sm:col-span-9">
                    <textarea id="af-account-bio" type="text" name="bio" required
                        ...
                        rows="6" placeholder="Type your message..."> {{old('bio', $student->bio)}} </textarea>
                </div>
                <!-- End Col -->
            </div>
            <!-- End Grid -->
